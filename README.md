...
前往 [Releases](../../releases) 下载 v1.4.13 的 Windows x64 安装包：

| 包 | 用途 |
| --- | --- |
| `Free-New-Desk-Setup-1.4.13-x64.exe` | NSIS 安装版（推荐，支持自动更新） |
| `Free-New-Desk-Portable-1.4.13-x64.exe` | 绿色版（无需安装，解压即用） |
...
- **播放器**：硬件解码、字幕 / 音轨 / 倍速 / 截图 / 全屏 / PiP / 播放队列，并增强 Seek 与异常恢复稳定性
- **音乐**：本地 / SMB / WebDAV 音乐库、曲目/歌手封面、手动封面、在线同步歌词与播放时钟
- **SMB / NAS**：原生 `smb-helper` 会话管理、稳定 Windows 数字错误码与显式凭据冲突处理
